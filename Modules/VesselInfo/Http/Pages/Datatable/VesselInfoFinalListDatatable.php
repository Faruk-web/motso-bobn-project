...
class VesselInfoFinalListDatatable extends DataTableComponent
{
    protected $index = 0;
    public function columns(): array
    {
        ...
        //    Column::make('User Name', 'User.name')->searchable()->sortable(),
           ...
           Column::make('Update Date', 'created_at')->searchable()->deselected()->sortable()->collapseOnMobile(),
        //    -----------------------------------
   ...
   public function bulkActions(): array
   {
    ...
    {
        $id = auth()->user()->id;
        return VesselInfo::with('User')->where('status', '1')->orderBy('name', 'asc'); // Select some things
    }
}
