...
<div class="form-group">
    ...
    <div class="form-control-wrap" wire:key="{{$jsId}}">
        <div wire:ignore>
            <select id="{{$jsId}}" @isset($attributes['multiple']) multiple @endisset {{$attributes->wire('model')}} class="@error($attributes->wire('model')->value) invalid @enderror {{$attributes['class']}}">
